...
lw $t1, 0($t1)		# t1 = 20
sll $t1, $t1, 2		# shift left logical 2 digits over, 0001 0100 -> 0101 0000 = 12(decimal)
subu $t1, $t0, $t1	# t1 is now 12 less than t0

inputLoop:
slt $t2, $t1, $t0		# if t1 < t0, set t2 = 1 else t2 = 0, start at 80,decrement 4 (20 iterations)
...
sw $v0, 76($t0)			# store the input into t0 starting from last spot in array
subiu $t0, $t0, 4		# interates to the next word position (we use 4 b/c it's a word)
				# 80, 76, 72,... 4
...
la $t0, array			#t1 is 12 more than t0
la $t1, array_size
